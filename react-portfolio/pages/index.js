  ...
  return (
    ...
    <div className={darkMode ? 'dark' : ""} >
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-slate-900'>
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            ...
            <ul className='flex items-center'>
              ...
              <li> 
                <a 
                className='text-white px-4 bg-gradient-to-r from-cyan-500 to-pink-500 py-2 rounded-md ml-8' 
                href="#">Resume</a></li>
            </ul>
          </nav>
        ...
        <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto  dark:text-gray-300'>  Freelancer providing services for programming and design content
...
<div className='lg:flex gap-10'>
  <div className='text-center shadow-lg p-10 rounded-xl my-10'>
    ...
    <p className='py-2  dark:text-gray-300'>  Creating elegant designs suited for your needs following core
                design theory.</p>
  ...
  <div className='text-center shadow-lg p-10 rounded-xl my-10'>
    <Image className='mx-auto' alt='design' src={code} width={100} height={100}/>
    <h3 className='text-lg font-medium pt-8 pb-2  dark:text-white'>Beautiful Designs</h3>
    <p className='py-2  dark:text-gray-300'>  Creating elegant designs suited for your needs following core
                design theory.</p>
                <h4 className='py-4 text-teal-600'> Design tools I use</h4>
  ...
  <div className='text-center shadow-lg p-10 rounded-xl my-10'>
    <Image className='mx-auto' alt='design' src={consulting} width={100} height={100}/>
    <h3 className='text-lg font-medium pt-8 pb-2  dark:text-white'>Beautiful Designs</h3>
    <p className='py-2  dark:text-gray-300'>  Creating elegant designs suited for your needs following core
                design theory.</p>
                <h4 className='py-4 text-teal-600'> Design tools I use</h4>
